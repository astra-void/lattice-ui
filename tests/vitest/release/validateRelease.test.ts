...
describe("release tag validation", () => {
  ...
  it("accepts prerelease tags and preserves the full package version", () => {
    expect(validatePackageVersionMatchesRelease("v0.1.0-alpha.1", "0.1.0-alpha.1", "@lattice-ui/react-runtime")).toEqual({
      tag: "v0.1.0-alpha.1",
  ...
  it("fails when a prerelease tag does not match the package version", () => {
    expect(() => validatePackageVersionMatchesRelease("v0.1.0-alpha.1", "0.1.0-beta.1", "@lattice-ui/react-runtime")).toThrow(
      "@lattice-ui/react-runtime version 0.1.0-beta.1 does not match release tag v0.1.0-alpha.1.",
    );
  });
  ...
  it("validates all publishable package versions against prerelease tags", () => {
    expect(() =>
      validateReleasePackageVersions("v0.1.0-alpha.1", [
        { name: "@lattice-ui/react-runtime", version: "0.1.0-alpha.1" },
        { name: "@lattice-ui/react-radio-group", version: "0.1.0-alpha.1" },
  ...
  it("fails when any publishable package version diverges from the release tag", () => {
    expect(() =>
      validateReleasePackageVersions("v0.1.0-alpha.1", [
        { name: "@lattice-ui/react-runtime", version: "0.1.0-alpha.1" },
        { name: "@lattice-ui/react-radio-group", version: "0.1.0-alpha.2" },
      ]),
    ).toThrow("@lattice-ui/react-radio-group version 0.1.0-alpha.2 does not match release tag v0.1.0-alpha.1.");
  });
});
